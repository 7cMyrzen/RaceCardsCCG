            ...
            <form className="shadow-input w-full rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black" onSubmit={handleSubmit}>
                <div className="my-8">
                    ...
                    <LabelInputContainer className="mb-4">
                        ...
                        <Input id="email" name="email" placeholder="joueur1@racecards.ccg" type="email" />
                    </LabelInputContainer>
                    <LabelInputContainer className="mb-4">
                ...
                <a className="w-full text-black cursor-pointer hover:underline dark:text-white" onClick={() => {window.location.href = "/auth/login"}}>Déja un compte ? Connectez vous !</a>
            </form >
        </div>
    );
}
