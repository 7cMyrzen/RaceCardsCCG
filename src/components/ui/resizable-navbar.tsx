...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  const [visible, setVisible] = useState<boolean>(true); // Initialiser à true

  useMotionValueEvent(scrollY, "change", (latest) => {
    // Sur desktop uniquement (lg et plus)
  ...
  return (
    ...
    >
      <img
        ...
        className="invert"
      />
      <span className="font-medium text-black dark:text-white">RaceCards</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-neutral-900 shadow-none dark:text-white",
    gradient:
